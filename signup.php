...
?>
    ...
    <body style = "background:rgb(252, 251, 251);">
        <label class = "logo" style = "margin-top:6em; margin-left:23em; margin-bottom: 2em; font-family:arial; letter-spacing:1px; font-size:1.4em;">
        ...
        <div class = "container-fluid" style = "background:white; margin-left:25em; margin-right:30em; width:32%; padding-left:1.5em; padding-right:1.5em; padding-bottom:2em; border: 1px solid rgb(223, 232, 248);" >
                ...
                <p style = "padding-top:1em; font-size:1.7em; font-weight:bold;">Create an account</p>
                ...
                <form action="signupdb.php" method="POST">
                    ...
                    <input type="checkbox" id="agreeCheckbox">
                        <label for="agreeCheckbox">I have read and agree with <a href="#">Terms of Service</a></label>
               
                
                    <button class="btn btn-primary" type="submit" style="padding-left:6em; padding-right:7em;">Create an account </button>
            </form> 
        </div>
